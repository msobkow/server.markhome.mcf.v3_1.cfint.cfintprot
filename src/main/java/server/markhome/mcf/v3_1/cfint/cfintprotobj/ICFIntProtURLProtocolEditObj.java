// Description: Java 25 Protected Instance Edit Object interface for CFInt URLProtocol.
...
public interface ICFIntProtURLProtocolEditObj
	extends ICFIntProtURLProtocolObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtURLProtocolObj.
	 */
	ICFIntProtURLProtocolObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtURLProtocolObj.
	 */
	ICFIntProtURLProtocolObj getOrigAsURLProtocol();
	 ...
	 */
	ICFIntProtURLProtocolObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtURLProtocolEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtURLProtocolEditObj deleteInstance();
