// Description: Java 25 Object interface for CFIntProt Tld.
...
public interface ICFIntProtTldObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFIntProtTld.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFIntProtTldObj instance which should be subsequently referenced.
	 */
	ICFIntProtTldObj realise();
	 ...
	 *
	 *	@return	ICFIntProtTldObj the reference to the cached or read (realised) instance.
	 */
	ICFIntProtTldObj read();
	 ...
	 *	@return	ICFIntProtTldObj the reference to the cached or read (realised) instance.
	 */
	ICFIntProtTldObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this Tld instance.
	 *
	 *	@return	The newly locked ICFIntProtTldEditObj edition of this instance.
	 */
	ICFIntProtTldEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFIntProtTldEditObj edition of this instance.
	 */
	ICFIntProtTldEditObj getEdit();

	/**
	 *	Get the current edition of this Tld instance as a ICFIntProtTldEditObj.
	 *
	 *	@return	The ICFIntProtTldEditObj edition of this instance.
	 */
	ICFIntProtTldEditObj getEditAsTld();

	/**
	 *	Get the ICFIntProtTldTableObj table cache which manages this instance.
	 *
	 *	@return	ICFIntProtTldTableObj table cache which manages this instance.
	 */
	ICFIntProtTldTableObj getTldTable();
	...
	/**
	 *	Get the ICFIntProtTld instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntProtTld instance which currently backs this object.
	 */
	ICFIntProtTld getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntProtTld value );
	...
	/**
	 *	Get the array of optional ICFIntProtTopDomainObj array of instances referenced by the TopDomain key.
	 *
	 *	@return	The optional ICFIntProtTopDomainObj[] array of instances referenced by the TopDomain key.
	 */
	List<ICFIntProtTopDomainObj> getOptionalComponentsTopDomain();
	 ...
	 *	@return	The optional ICFIntProtTopDomainObj[] array of instances referenced by the TopDomain key.
	 */
	List<ICFIntProtTopDomainObj> getOptionalComponentsTopDomain( boolean forceRead );
