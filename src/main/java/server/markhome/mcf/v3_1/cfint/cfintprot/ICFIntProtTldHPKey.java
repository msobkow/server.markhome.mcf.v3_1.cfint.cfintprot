// Description: Java 25 protected interface for a Tld history primary key object
...
/**
 *	ICFIntProtTldHPKey Protected History Primary Key interface for Tld has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredId	Required object attribute Id. */
public interface ICFIntProtTldHPKey
{
