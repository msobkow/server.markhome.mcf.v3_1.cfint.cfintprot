...
/**
 *	ICFIntProtURLProtocolByIsSecureIdxKeys has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFIntProtURLProtocolByIsSecureIdxKey
{
