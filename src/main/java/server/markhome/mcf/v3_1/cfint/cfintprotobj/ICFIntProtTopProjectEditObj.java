// Description: Java 25 Protected Instance Edit Object interface for CFInt TopProject.
...
public interface ICFIntProtTopProjectEditObj
	extends ICFIntProtTopProjectObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtTopProjectObj.
	 */
	ICFIntProtTopProjectObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtTopProjectObj.
	 */
	ICFIntProtTopProjectObj getOrigAsTopProject();
	 ...
	 */
	ICFIntProtTopProjectObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtTopProjectEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtTopProjectEditObj deleteInstance();
	...
	/**
	 *	Get the ICFIntProtTopDomainObj instance referenced by the ParentSDom key.
	 *
	 *	@return	The ICFIntProtTopDomainObj instance referenced by the ParentSDom key.
	 */
	...
	/**
	 *	Set the ICFIntProtTopDomainObj instance referenced by the ParentSDom key.
	 *
	 *	@param	value	the ICFIntProtTopDomainObj instance to be referenced by the ParentSDom key.
	 */
	void setRequiredContainerParentSDom( ICFIntProtTopDomainObj value );

	/**
	 *	Get a list ICFIntProtSubProjectObj instances referenced by the SubProject key.
	 *
	 *	@return	The (potentially empty) list of ICFIntProtSubProjectObj instances referenced by the SubProject key.
	 */
