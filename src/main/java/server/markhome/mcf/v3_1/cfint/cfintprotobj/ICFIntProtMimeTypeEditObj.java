// Description: Java 25 Protected Instance Edit Object interface for CFInt MimeType.
...
public interface ICFIntProtMimeTypeEditObj
	extends ICFIntProtMimeTypeObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtMimeTypeObj.
	 */
	ICFIntProtMimeTypeObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtMimeTypeObj.
	 */
	ICFIntProtMimeTypeObj getOrigAsMimeType();
	 ...
	 */
	ICFIntProtMimeTypeObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtMimeTypeEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtMimeTypeEditObj deleteInstance();
