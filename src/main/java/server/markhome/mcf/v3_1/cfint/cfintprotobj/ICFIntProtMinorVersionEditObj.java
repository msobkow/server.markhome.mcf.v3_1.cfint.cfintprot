// Description: Java 25 Protected Instance Edit Object interface for CFInt MinorVersion.
...
public interface ICFIntProtMinorVersionEditObj
	extends ICFIntProtMinorVersionObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtMinorVersionObj.
	 */
	ICFIntProtMinorVersionObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtMinorVersionObj.
	 */
	ICFIntProtMinorVersionObj getOrigAsMinorVersion();
	 ...
	 */
	ICFIntProtMinorVersionObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtMinorVersionEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtMinorVersionEditObj deleteInstance();
	...
	/**
	 *	Get the ICFIntProtMajorVersionObj instance referenced by the ParentMajVer key.
	 *
	 *	@return	The ICFIntProtMajorVersionObj instance referenced by the ParentMajVer key.
	 */
	...
	/**
	 *	Set the ICFIntProtMajorVersionObj instance referenced by the ParentMajVer key.
	 *
	 *	@param	value	the ICFIntProtMajorVersionObj instance to be referenced by the ParentMajVer key.
	 */
	void setRequiredContainerParentMajVer( ICFIntProtMajorVersionObj value );
