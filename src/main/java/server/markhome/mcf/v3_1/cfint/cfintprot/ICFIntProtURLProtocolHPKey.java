// Description: Java 25 protected interface for a URLProtocol history primary key object
...
/**
 *	ICFIntProtURLProtocolHPKey Protected History Primary Key interface for URLProtocol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredURLProtocolId	Required object attribute URLProtocolId. */
public interface ICFIntProtURLProtocolHPKey
{
