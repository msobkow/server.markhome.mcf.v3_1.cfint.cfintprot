...
// Description: Java 25 protlic DbIO interface for License.
...
/*
 *	CFIntProtLicenseTable protlic database interface for License has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFIntProtLicenseTable
extends ICFIntPubLicenseTable
{
