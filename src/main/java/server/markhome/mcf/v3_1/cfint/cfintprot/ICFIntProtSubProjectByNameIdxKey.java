// Description: Java 25 protected interface for a SubProject by NameIdx index key object
...
/**
 *	ICFIntProtSubProjectByNameIdxKeys has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
