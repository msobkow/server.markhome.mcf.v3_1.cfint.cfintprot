// Description: Java 25 Object interface for CFIntProt SubProject.
...
public interface ICFIntProtSubProjectObj
	extends ICFLibAnyObj
{
	/**
	 *	Initially, the class code for an object is ICFIntProtSubProject.CLASS_CODE, but the Obj layer relies on class code translation to map those
	 ...
	 *
	 *	@return	CFIntProtSubProjectObj instance which should be subsequently referenced.
	 */
	ICFIntProtSubProjectObj realise();
	 ...
	 *
	 *	@return	ICFIntProtSubProjectObj the reference to the cached or read (realised) instance.
	 */
	ICFIntProtSubProjectObj read();
	 ...
	 *	@return	ICFIntProtSubProjectObj the reference to the cached or read (realised) instance.
	 */
	ICFIntProtSubProjectObj read( boolean forceRead );

	/**
	 *	Initialize and return a locked edition of this SubProject instance.
	 *
	 *	@return	The newly locked ICFIntProtSubProjectEditObj edition of this instance.
	 */
	ICFIntProtSubProjectEditObj beginEdit();
	 ...
	 *
	 *	@return	The ICFIntProtSubProjectEditObj edition of this instance.
	 */
	ICFIntProtSubProjectEditObj getEdit();

	/**
	 *	Get the current edition of this SubProject instance as a ICFIntProtSubProjectEditObj.
	 *
	 *	@return	The ICFIntProtSubProjectEditObj edition of this instance.
	 */
	ICFIntProtSubProjectEditObj getEditAsSubProject();

	/**
	 *	Get the ICFIntProtSubProjectTableObj table cache which manages this instance.
	 *
	 *	@return	ICFIntProtSubProjectTableObj table cache which manages this instance.
	 */
	ICFIntProtSubProjectTableObj getSubProjectTable();
	...
	/**
	 *	Get the ICFIntProtSubProject instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFIntProtSubProject instance which currently backs this object.
	 */
	ICFIntProtSubProject getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFIntProtSubProject value );
	 ...
	 *	@return	ICFIntProtSubProject instance which currently backs this object.
	 */
	ICFIntProtSubProject getSubProjectRec();
	...
	/**
	 *	Get the array of optional ICFIntProtMajorVersionObj array of instances referenced by the MajorVer key.
	 *
	 *	@return	The optional ICFIntProtMajorVersionObj[] array of instances referenced by the MajorVer key.
	 */
