// Description: Java 25 protected interface for a MimeType history primary key object
...
/**
 *	ICFIntProtMimeTypeHPKey Protected History Primary Key interface for MimeType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 *		requiredMimeTypeId	Required object attribute MimeTypeId. */
public interface ICFIntProtMimeTypeHPKey
{
