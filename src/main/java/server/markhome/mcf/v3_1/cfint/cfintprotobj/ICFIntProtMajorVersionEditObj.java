// Description: Java 25 Protected Instance Edit Object interface for CFInt MajorVersion.
...
public interface ICFIntProtMajorVersionEditObj
	extends ICFIntProtMajorVersionObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtMajorVersionObj.
	 */
	ICFIntProtMajorVersionObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtMajorVersionObj.
	 */
	ICFIntProtMajorVersionObj getOrigAsMajorVersion();
	 ...
	 */
	ICFIntProtMajorVersionObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtMajorVersionEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtMajorVersionEditObj deleteInstance();
	...
	/**
	 *	Get the ICFIntProtSubProjectObj instance referenced by the ParentSPrj key.
	 *
	 *	@return	The ICFIntProtSubProjectObj instance referenced by the ParentSPrj key.
	 */
	...
	/**
	 *	Set the ICFIntProtSubProjectObj instance referenced by the ParentSPrj key.
	 *
	 *	@param	value	the ICFIntProtSubProjectObj instance to be referenced by the ParentSPrj key.
	 */
	void setRequiredContainerParentSPrj( ICFIntProtSubProjectObj value );

	/**
	 *	Get a list ICFIntProtMinorVersionObj instances referenced by the MinorVer key.
	 *
	 *	@return	The (potentially empty) list of ICFIntProtMinorVersionObj instances referenced by the MinorVer key.
	 */
