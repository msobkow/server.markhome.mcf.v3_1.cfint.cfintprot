// Description: Java 25 Protected Instance Edit Object interface for CFInt TopDomain.
...
public interface ICFIntProtTopDomainEditObj
	extends ICFIntProtTopDomainObj
{
	/*
	 *	Get the original for this edition as the base type for the class hierarchy.
	 *
	 *	@return The original, non-modifiable instance as a base ICFIntProtTopDomainObj.
	 */
	ICFIntProtTopDomainObj getOrig();

	/*
	 *	Get the original for this edition cast as the specified type.
	 *
	 *	@return The original, non-modifiable instance cast to a ICFIntProtTopDomainObj.
	 */
	ICFIntProtTopDomainObj getOrigAsTopDomain();
	 ...
	 */
	ICFIntProtTopDomainObj create();

	/*
	 *	Update the instance.
	 */
	ICFIntProtTopDomainEditObj update();

	/*
	 *	Delete the instance.
	 */
	ICFIntProtTopDomainEditObj deleteInstance();
	...
	/**
	 *	Get the ICFIntProtTldObj instance referenced by the ParentTld key.
	 *
	 *	@return	The ICFIntProtTldObj instance referenced by the ParentTld key.
	 */
	...
	/**
	 *	Set the ICFIntProtTldObj instance referenced by the ParentTld key.
	 *
	 *	@param	value	the ICFIntProtTldObj instance to be referenced by the ParentTld key.
	 */
	void setRequiredContainerParentTld( ICFIntProtTldObj value );

	/**
	 *	Get a list ICFIntProtTopProjectObj instances referenced by the TopProject key.
	 *
	 *	@return	The (potentially empty) list of ICFIntProtTopProjectObj instances referenced by the TopProject key.
	 */
	List<ICFIntProtTopProjectObj> getOptionalComponentsTopProject();

	/**
	 *	Get a list ICFIntProtLicenseObj instances referenced by the License key.
	 *
	 *	@return	The (potentially empty) list of ICFIntProtLicenseObj instances referenced by the License key.
	 */
